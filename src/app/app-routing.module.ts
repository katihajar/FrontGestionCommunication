  ...
  imports: [RouterModule.forRoot([
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'healthcheck/Monetics/registre', component: RegistrHealthCheckProdRespoComponent },
        { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
      ],
    },
    {
      ...
      children: [
        ...
        { path: 'healthcheck/Monetics/registre', component: RegistreHealthCheckComponent },
        { path: 'healthcheck/Monetics/save', component: AjoutHealthCheckComponent },
        { path: 'healthcheck/Flamingo/save', component: AjouterHealthCheckFlamingoComponent },
        { path: 'healthcheck/BI/save', component: AjoutHealthCheckBwPerimetreComponent },
        { path: 'healthcheck/BI/save', component: AjoutHealthCheckBwPerimetreComponent },
