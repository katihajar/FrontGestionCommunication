...
@Component({
  selector: 'app-registr-health-check-prod',
  templateUrl: './registr-health-check-prod.component.html',
  styleUrls: ['./registr-health-check-prod.component.scss']
})
export class RegistrHealthCheckProdComponent implements OnInit {
